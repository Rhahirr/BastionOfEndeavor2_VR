...
/obj/item/weapon/storage/part_replacer
	name = "Устройство быстрой замены компонентов (УБЗК)"
...
/obj/item/weapon/storage/part_replacer/adv
	name = "Усовершенствованное устройство быстрой замены компонентов (УБЗК)"
...
/obj/item/weapon/storage/part_replacer/adv/discount_bluespace
	name = "Синепространственное устройство быстрой замены компонентов (УБЗК)"
	...
	case_blueprint_ru = list("сред#синепространственн;adj1*a((1)) устройств;n1a быстрой замены компонентов")
...
/obj/item/weapon/research
	name = "Инструмент отладки исследований"
	desc = "Инструмент для моментальной прокачки исследований. Только для тестирования."
	case_blueprint_ru = list("муж#инструмент;n1a отладки исследований")
