...
//	var/static/enable_authentication = 0		// goon authentication
	...
	*/
	var/static/respawn_message = "<span class='notice'><B>Не забудьте выбрать другого персонажа и правильно отыгрывать!</B></span>"
	...
	*/
	...
	var/static/alert_desc_orange_downto = "В силу вступил оранжевый код. Сотрудникам инженерного отдела необходимо получить приказы от вышестоящего лица, всем остальным необходимо покинуть опасные зоны и следовать инструкциям инженеров."
