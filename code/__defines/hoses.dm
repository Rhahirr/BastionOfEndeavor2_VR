/* Bastion of Endeavor Translation: Makes the most sense to me, given the usage
...
*/
#define HOSE_INPUT  "Принимающий"
#define HOSE_OUTPUT "Отдающий"
#define HOSE_NEUTRAL "Выравнивающий"
