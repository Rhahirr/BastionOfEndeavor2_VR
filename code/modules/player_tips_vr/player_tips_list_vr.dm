	...
	switch(choice)
		...
		if("Сеттинг и лор")
			...
			return pick(
				...
				prob(50); "[info] В отличие от других серверов, развитие таджар и унати обошлось без участия человечества, что привело к появлению собственной культуры у обеих рас. Они обладают равными с людьми правами. https://bastionofendeavor.ddns.net/wiki/index.php/Предыстория#Распространенные_расы",
