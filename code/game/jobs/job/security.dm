...
/datum/job/warden
	...
	*/
	job_description = "Надзиратель отвечает непосредственно за блок службы безопасности на станции и поддерживает порядок в Бриге и Арсенале. \
						Он наблюдает за заключенными, отправленными в бриг, и отвечает за их безопасность и здоровье. \
						В случае чрезвычайного положения надзиратель распоряжается выдачей снаряжения из Арсенала и отвечает за его сбор, как только кризис миновал. \
...
/datum/job/detective
	...
	*/
	job_description = "Детектив позволяет службе безопасности идентифицировать преступников с помощью допросов и судебно-медицинской экспертизы. \
...
/datum/job/officer
	...
	*/
	job_description = "Офицер службы безопасности отвечает за безопасность персонала и порядок на территории станции, и в его обязанности входит как защита станции от внешних угроз, \
						так и арест преступников. Офицер ответственнен за безопасность и здоровье каждого арестованного, а также обязуется обеспечивать своевременное оформление всех сопутствующих документов. \
...
/datum/alt_title/junior_officer
	...
	*/
	...
	title_blurb = "Младший офицер, вероятно, уже прошёл обучение, но не обладает достаточным опытом, чтобы считаться полноценным офицером. \
					...
					- например, патрулирование или наблюдение на постах."
	// End of Bastion of Endeavor Translation