...
/datum/alt_title/maint_tech
	...
	*/
	...
	title_blurb = "Техник по обслуживанию, как правило, стоит чуть ниже инженера и занимается преимущественно неприятными или неинтересными задачами, за которые не хотят браться они сами."
	// End of Bastion of Endeavor Translation
...
/datum/alt_title/engine_tech
	...
	*/
	...
	title_blurb = "Наладчик двигателей занимается установкой и техобслуживанием двигателей - как правило, шара Теслы или кристалла суперматерии. \
					От наладчика ожидается поддерживание стабильных показателей при работе двигателя и, по возможности, выведение его на более высокие мощности."
	// End of Bastion of Endeavor Translation
